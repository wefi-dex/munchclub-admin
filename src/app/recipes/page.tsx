    ...
    <div className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
        ...
        <div className="p-3">
            <div className="flex items-start justify-between mb-2">
                <h3 className="font-medium text-gray-900 truncate flex-1 text-sm">{recipe.title}</h3>
                <span className={`px-1.5 py-0.5 text-xs rounded-full ${getDifficultyColor(recipe.difficulty || 'easy')}`}>
            ...
            <div className="flex items-center justify-between mb-3">
                <span className="text-xs text-gray-500">By {recipe.author.name}</span>
            ...
            <div className="flex space-x-1">
                ...
                <button className="flex-1 bg-gray-100 text-gray-700 px-2 py-1.5 rounded text-xs hover:bg-gray-200 flex items-center justify-center">
                    <Edit className="w-3 h-3 mr-1" />
                    Edit
                </button>
                <button className="bg-red-100 text-red-700 px-2 py-1.5 rounded text-xs hover:bg-red-200">
